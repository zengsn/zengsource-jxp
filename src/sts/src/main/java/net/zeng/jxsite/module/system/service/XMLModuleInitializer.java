	...
	public void init() throws InitializationException {
		...
		try {
			...
			if (StringUtil.notBlank(status)) {
				this.module.setStatus(NumberUtil.string2Integer(status, Module.OFFLINE));
			} 
		...
		if (!this.module.isOnline()) { // if not manually set online
