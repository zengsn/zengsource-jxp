 ...
 * {@link org.springframework.security.acls.domain.AclImpl} and
 * {@link org.springframework.security.acls.domain.AccessControlEntryImpl} to be
 * set, so that the implementation can detect changed parameters easily.
 * </p>
 * 
 * @author Ben Alex
