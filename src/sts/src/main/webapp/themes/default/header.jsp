<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8"%>
			...
			<div id="hd-inner">
				...
				<div id="navi">
					<ul>
					<li><a href="<%=request.getContextPath()%>/index.${_PAGE_URL_SUFFIX_}" id="navi-home" title="首页" class="">首页</a></li>
					...
					<li><a href="<%=request.getContextPath()%>/modules/aboutus/index.${_PAGE_URL_SUFFIX_}" id="navi-aboutus" title="关于我们" class="">关于我们</a></li>
					</ul>
				</div>
