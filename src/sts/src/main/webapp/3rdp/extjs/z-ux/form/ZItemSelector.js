/*!
 * Z-JXP UI, baseed on ExtJS.
 * Copyright(c) 2008-2010 Zeng-IT
 * licensing@zeng-it.com
 * http://www.zeng-it.com/license
 */
/*
 ...
 * @xtype itemselector 
 */
Ext.namespace('Z.ux.form');
Z.ux.form.ItemSelector = Ext.extend(Ext.form.Field,  {
    hideNavIcons:false,
    imagePath:"",
    iconUp:"up2.gif",
    iconDown:"down2.gif",
    ...
    initComponent: function(){
        Z.ux.form.ItemSelector.superclass.initComponent.call(this);
        this.addEvents({
            'rowdblclick' : true,
            'change' : true
        });
    ...
    onRender: function(ct, position){
        Z.ux.form.ItemSelector.superclass.onRender.call(this, ct, position);
        ...
        this.iconAll = this.imagePath + (this.iconAll || 'all2.gif');
        this.iconClear = this.imagePath + (this.iconClear || 'clear2.gif');
        var el=icons.getEl();
        this.toTopIcon = el.createChild({tag:'img', src:this.iconTop, style:{cursor:'pointer', margin:'2px'}});
        el.createChild({tag: 'br'});
        this.upIcon = el.createChild({tag:'img', src:this.iconUp, style:{cursor:'pointer', margin:'2px'}});
        el.createChild({tag: 'br'});
        this.allIcon = el.createChild({tag:'img', src:this.iconAll, style:{cursor:'pointer', margin:'2px'}});
        el.createChild({tag: 'br'});
        ...
        el.createChild({tag: 'br'});
        this.clearIcon = el.createChild({tag:'img', src:this.iconClear, style:{cursor:'pointer', margin:'2px'}});
        el.createChild({tag: 'br'});
        ...
        this.allIcon.on('click', this.all, this);
        this.clearIcon.on('click', this.reset, this);
        ...
        if (!this.drawAllIcon || this.hideNavIcons) { this.allIcon.dom.style.display='none'; }
        if (!this.drawClrIcon || this.hideNavIcons) { this.clearIcon.dom.style.display='none'; }
    ...
    afterRender: function(){
        Z.ux.form.ItemSelector.superclass.afterRender.call(this);
...
Ext.reg('zitemselector', Z.ux.form.ItemSelector);

//backwards compat
Z.ux.ItemSelector = Z.ux.form.ItemSelector;
